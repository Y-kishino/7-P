...
<body>
    ...
    <main style="height: 115vh;">
        <form method="post" action="update_confirm.php" name="form" onsubmit="return check();">
            ...
            <div>
                ...
                <select name="textAuth" id="" class="textAuth">
                    ...
                    <option value="1" <?php if(!empty($_POST['authority'])&&$_POST['authority']==="1"){
                        echo 'selected';
                        }?>>  管理者  </option>
                </select>
                <br>
            ...
            <input type="hidden" value="<?php if(!empty($_POST['UPT'])){
                echo $_POST['UPT'];
                }?>" name="UPT">
            <input type="hidden" value="<?php if(!empty($_POST['id'])){
                echo $_POST['id'];
            }?>" name="id">
            <div id="submitArea">
